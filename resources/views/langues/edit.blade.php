    ...
    <div class="col-lg-8 offset-lg-2">
        <div class="card mb-4">
            <div class="card-header">
                <h3 class="card-title">Modification de : {{ $langues->nom_langue }}</h3>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('langues.update', $langues->id) }}" method="POST">
                    @csrf
                    @method('PUT') {{-- Nécessaire pour les requêtes de mise à jour --}}
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('code_langue') is-invalid @enderror" 
                               ...
                               value="{{ old('code_langue', $langues->code_langue) }}" 
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('nom_langue') is-invalid @enderror" 
                               ...
                               value="{{ old('nom_langue', $langues->nom_langue) }}" 
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  rows="3">{{ old('description', $langues->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-success">Mettre à jour la langue</button>
                    </div>
                </form>
            </div>
        </div>
