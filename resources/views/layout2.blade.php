...
<body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
  ...
  <div class="app-wrapper">
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
              <img
                src="{{URL::asset('adminLTE/img/') }}"
                class="user-image rounded-circle shadow"
                alt="User Image" />
              <span class="d-none d-md-inline">Israel Admin</span>
            </a>
    ...
    <!--end::Header-->
    <!--begin::Sidebar-->
    <aside class="app-sidebar shadow" style="background-color: #e5e7eb;">
        ...
        <nav class="mt-2">
          ...
          <ul
            ...
            <li class="nav-item menu-open">
              <a href="{{ route('utilisateurs.dashboard') }}" class="nav-link">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('type_contenu.index') }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>TypeContenu</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('type_media.index') }}" class="nav-link">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>TypeMedia</p>
                  </a>
                </li>
